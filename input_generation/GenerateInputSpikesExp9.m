function [spikes_binary, spiketimes] = GenerateInputSpikesExp9(exp, T0, dt, ~)

    % Get spike trains
    [sb, st] = GenerateInputSpikesUncorrelated(1, exp.rate1, T0, dt, '');
    [sb2, st2] = GenerateInputSpikesUncorrelated(1, exp.rate1, T0, dt, '');
