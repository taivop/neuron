...
ylabel(subplot(2,3,4), 'Mean final weight');
ylabel(subplot(2,3,1), 'Mean final weight');
...
print('../../bscthesis/figures/exp8_gridweights_epsp3.eps', '-depsc');
