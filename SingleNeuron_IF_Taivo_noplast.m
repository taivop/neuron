function [g_plas, rate_Output] = SingleNeuron_IF_Taivo_noplast(T0, rate_Input, initialWeight)
...
%% Write data to file
fileName = sprintf('out_noplast_%s.mat', datestr(now,'yyyy-mm-dd_HH-MM-SS'));
cd data_out;
...
save(fileName, 'rate_Input', 'rate_Output','T0','dt','I0','gExc','gInh','Vmat','g_plas0','g_plas','rE','rI','endExc','startInh','numDendrites','totalComputingTime','enableMetaplasticity','enableInhplasticity','Ca_history','spikes_post');
cd ..;